...
public class PersistentStreamConfig {
    ...
    static QueueDefinition persistentJobs = new PersistentQueueDefinition("Blueprint.Scheduled.Persistent", "MyJob", Duration.ofSeconds(5)).setMaxAttempts(2).setConcurrency(1);
    ...
    public static ConsumerDefinition persistentJobConsumer = new ConsumerDefinition(PERSISTENT_JOB_PROCESSOR, persistentJobs);
